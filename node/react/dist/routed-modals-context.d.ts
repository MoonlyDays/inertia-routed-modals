...
export declare const RoutedModalsContext: import("react").Context<RoutedModalsContextProps | undefined>;
export declare function useRoutedModalsProvider(): RoutedModalsContextProps;
export {};
